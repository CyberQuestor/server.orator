  ...
  if (!process.env.studio_token) {
    function conductOnboarding(bot, message) {
      ...
      bot.startConversation(message, function(err, convo) {
        ...
        convo.say({
          text: 'If you are new here, check out what I am about.',
          quick_replies: [
            {
              title: 'What are you?',
              payload: 'what are you?',
            },
            {
              title: 'I am ready to sign-up',
              payload: 'lets start using!',
            }
          ]
        });
    ...
    function unhandledMessage(bot, message) {
      ...
      bot.startConversation(message, function(err, convo) {
        ...
        convo.say({
          ...
          text: 'But I am constantly learning as we speak.',
          quick_replies: [
            {
              title: 'What are you?',
              payload: 'what are you?',
            ...
            {
              title: 'I am ready to try it out!',
              payload: 'lets start using!',
            }
          ]
        });
    ...
    controller.hears('people','message_received', function(bot, message) {
      bot.reply(message, { type: "typing" });
      bot.startConversation(message, function(err, convo) {
    ...
    controller.hears('legal','message_received', function(bot, message) {
      bot.reply(message, { type: "typing" });
      bot.startConversation(message, function(err, convo) {
    ...
    controller.hears('wealth','message_received', function(bot, message) {
      bot.reply(message, { type: "typing" });
      bot.startConversation(message, function(err, convo) {
    ...
    controller.hears(['what are you'],'message_received', function(bot, message) {
      bot.reply(message, { type: "typing" });
      ...
      bot.startConversation(message, function(err, convo) {
          ...
          convo.ask({
            text: 'Do you want to know more about the themes I can provide?',
            quick_replies: [
              {
                title: 'Wealth',
                payload: 'wealth',
